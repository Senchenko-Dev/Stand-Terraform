...
psql -c "grant all on schema currency_rates to currency_rates;"
psql -c "grant all on schema currency_rates to currency_rates_appl;"
psql -c "alter user currency_rates VALID UNTIL 'infinity';"
psql -c "grant usage on schema currency_rates to currency_rates;"
psql -c "grant usage on schema currency_rates to currency_rates_appl;"
...
psql -c "alter default privileges in schema currency_rates grant ALL on tables to currency_rates_appl;"
...
psql -c "grant all privileges on all tables in schema currency_rates to currency_rates_appl;"
